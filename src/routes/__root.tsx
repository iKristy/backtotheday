...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "What day was it? Pick any date to find out. No plutonium required." },
      { name: "author", content: "@iKristy" },
      { property: "og:title", content: "Back to the Day" },
      { property: "og:description", content: "What day was it? Pick any date to find out. No plutonium required." },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@iKristy" },
